// src/main.js
/**
 * Main entry point for EfficientCryptoLab application
 */
...
class EfficientCryptoLab {
    /**
     * Create a new EfficientCryptoLab instance
...
module.exports = EfficientCryptoLab;
...
if (require.main === module) {
    ...
    const app = new EfficientCryptoLab({
        input: args.input,
        output: args.output,
